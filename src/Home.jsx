  ...
  return (
    ...
    <div className='bg-[#A46CE5] h-screen'>
      <div className='flex justify-center pt-5'>
        <img className='w-72' src={upperimg} alt="" />
      </div>
      <div className=' m-auto bg-white w-[80%] h-72 rounded-3xl pt-3'>
        <h1 className='font-bold text-[33px] text-[#280A82] text-center'>Interesting QUIZ Awaits You</h1>
        <p className='text-center pt-8 text-[#7e7d7d] text-[26px]'>play quizzes with your friends<br/>
